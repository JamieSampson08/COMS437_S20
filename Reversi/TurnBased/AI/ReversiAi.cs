...
namespace AI
{
    class ReversiAi
    {
        ...
        public const ConsoleColor ComputerColor = ConsoleColor.DarkRed;
        public const ConsoleColor PlayerColor = ConsoleColor.Green;
        public const ConsoleColor InfoColor = ConsoleColor.Black;
        ...
        static void Main(string[] args)
        {
            ...
            while (!board.IsTerminal())
            {
                ...
                // show current score board after every move
                Console.ForegroundColor = InfoColor;
                Console.WriteLine("--------------------------");
        ...
        /// <summary>
        /// MinMax algorithm with alpha beta pruning to do predictive AI logic for best move to make
        /// </summary>
        /// <param name="board">current board state</param>
        /// <param name="rootPlayer">the inital player to make first move</param>
        /// <param name="maxDepth">how far to look forward</param>
        /// <param name="currentDepth">current look forward point</param>
        /// <param name="alpha">best already explored option along path to root for maximizer</param>
        /// <param name="beta">best already explored option along path to root for minimizer</param>
        /// <returns></returns>
